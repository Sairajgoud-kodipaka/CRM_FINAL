    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <div className="opacity-50 rounded-full h-12 w-12 border-b-2 border-primary mx-auto mb-4"></div>
        ...
        <div className="p-6">
          ...
          {loading ? (
            <div className="text-center py-8">
              <div className="opacity-50 rounded-full h-8 w-8 border-b-2 border-primary mx-auto mb-4"></div>
