...
import { User, Package, DollarSign, Search, Filter, Download } from "lucide-react";
...
export default function ManagerPurchasesPage() {
  ...
  const filteredData = [...(purchases || []), ...(closedWonDeals || [])].filter((item) => {
    // Ensure item and item.client exist before accessing properties
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            View all customer purchases and closed won deals for your store
          </p>
        </div>
